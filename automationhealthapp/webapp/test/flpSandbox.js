		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#automationhealthapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"automationhealthapp-display": {
								"semanticObject": "automationhealthapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=automationhealthapp",
									"url": sap.ui.require.toUrl("automationhealthapp")
								}
							}
						}
					}
