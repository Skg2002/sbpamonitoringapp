		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#detaillogsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"detaillogsapp-display": {
								"semanticObject": "detaillogsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=detaillogsapp",
									"url": sap.ui.require.toUrl("detaillogsapp")
								}
							}
						}
					}
