		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#workflowinstanceapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"workflowinstanceapp-display": {
								"semanticObject": "workflowinstanceapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=workflowinstanceapp",
									"url": sap.ui.require.toUrl("workflowinstanceapp")
								}
							}
						}
					}
