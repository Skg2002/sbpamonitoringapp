		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Deleted Instances Logs",
									"targetURL": "#deletedinstanceslogsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"deletedinstanceslogsapp-display": {
								"semanticObject": "deletedinstanceslogsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=deletedinstanceslogsapp",
									"url": sap.ui.require.toUrl("deletedinstanceslogsapp")
								}
							}
						}
					}
